...
const ReleaseUrl = "https://api.github.com/repos/PangwenE/orion-vencord-builder/releases/tags/vencord-orion"
const ReleaseUrlFallback = ""
const InstallerReleaseUrl = ""
const InstallerReleaseUrlFallback = ""

var UserAgent = "OrionVencordInstaller/" + buildinfo.InstallerGitHash + " (https://github.com/PangwenE/OrionVencordInstaller)"
